...
function SurveyCommandCenterFallbackContent({ nowMs: _nowMs }: { nowMs: number }) {
...
export function SurveyCommandFallback({ nowMs }: { nowMs: number }) {
  return (
    <RoleGate
      mode="page"
    ...
    >
      <SurveyCommandCenterFallbackContent nowMs={nowMs} />
    </RoleGate>
  )
}
