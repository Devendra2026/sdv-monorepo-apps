...
import { normalizeSignupMetadata } from "../users/helpers"
...
/** Clerk user.created / user.updated / user.deleted webhook handler. */
export const clerkWebhook = httpAction(async (ctx, request) => {
  ...
  switch (event.type) {
    ...
    case "user.deleted": {
      await ctx.runMutation(internal.users.internal.softDeleteFromClerk, {
